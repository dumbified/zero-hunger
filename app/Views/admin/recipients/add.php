        ...
        <div class="card-body p-6">
            ...
            <form method="post" action="<?= site_url('admin/recipients/add') ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="contact_info" rows="3" class="textarea textarea-bordered w-full bg-[#fffaf2] border-[#e3d6c2] focus:outline-none focus:border-[#f2b23a] focus:ring-1 focus:ring-[#f2b23a]" placeholder="Phone, email, etc."><?= old('contact_info') ?></textarea>
                </div>
                <div>
